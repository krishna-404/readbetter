...
function BooksController() {
  ...
  this.updateBook = async function(req, res) {
    ...
    } else if(req.params.book_id == "updateBook"){

      // console.log('updateBook', req.body, req);
              ...
              let $ = cheerio.load(uriRes.body);
                  ...
                  elements.each((i, dat) => {
                    // console.log($(dat));
                      ...
                      let pos = $(dat).text().trim().lastIndexOf(':')+2;
